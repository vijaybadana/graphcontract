  ...
  },
  {
    ...
    graph: graph(
      ...
      [
        ...
        start('researcher-start', 32, 148, 'researcher-workflow'),
        step('dispatch-research', 'Dispatch research', 'deterministic', 260, 148, {
          parentId: 'researcher-workflow',
        }),
        step('researcher-agent', 'Researcher Agent', 'ai', 500, 148, {
          parentId: 'researcher-workflow',
        }),
        {
          id: 'research-merge',
        ...
        step('research-tools', 'Research Tools', 'tool', 980, 148, {
          parentId: 'researcher-workflow',
        }),
        step('compress-findings', 'Compress Findings', 'deterministic', 1220, 148, {
          parentId: 'researcher-workflow',
        }),
        end('researcher-end', 'Researcher complete', 1460, 148, 'researcher-workflow'),
      ...
      [
        ...
        { id: 'frame-researcher', source: 'frame-question', target: 'researcher-start', mode: 'conditional', label: 'continue', condition: 'supervisor.researchRequired' },
        ...
        { id: 'merge-tools', source: 'research-merge', target: 'research-tools', mode: 'normal' },
        { id: 'tools-compress', source: 'research-tools', target: 'compress-findings', mode: 'normal' },
        { id: 'compress-researcher-end', source: 'compress-findings', target: 'researcher-end', mode: 'normal' },
        { id: 'researcher-supervisor-loop', source: 'researcher-end', target: 'frame-question', mode: 'normal', loopCap: 2 },
      ...
      [
        {
          ...
          dimensions: { width: 1936, height: 1100 },
          collapsed: false,
        },
        {
